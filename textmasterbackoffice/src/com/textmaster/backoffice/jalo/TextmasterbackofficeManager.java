 ...
 */
package com.textmaster.backoffice.jalo;
 ...
 */
public class TextmasterbackofficeManager extends GeneratedTextmasterbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextmasterbackofficeManager.class.getName());
	 ...
	 */
	public static TextmasterbackofficeManager getInstance()
	{
		return (TextmasterbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextmasterbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextmasterbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextmasterbackofficeManager called.");
		}
	}
	...
	/**
	 * Implement this method to createProjects initial objects. This method will be called by system creator during
	 * initialization and system update. Be sure that this method can be called repeatedly.
	 *
	 * An example usage of this method is to createProjects required cronjobs or modifying the type system (setting e.g some
	 * default values)
	 *
	 * @param params
	...
	/**
	 * Implement this method to createProjects data that is used in your project. This method will be called during the system
	 * initialization.
	 *
