 ...
 *  
 */
package com.textmaster.core.jalo;
...
/**
 * This is the extension manager of the Textmastercore extension.
 */
public class TextmastercoreManager extends GeneratedTextmastercoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextmastercoreManager.class.getName());
	 ...
	 */
	public static TextmastercoreManager getInstance()
	{
		return (TextmastercoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TextmastercoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextmastercoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextmastercoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextmastercoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TextmastercoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}

	/**
	 * Implement this method to createProject initial objects. This method will be called by system creator during
	 * initialization and system update. Be sure that this method can be called repeatedly.
	 * 
	 * An example usage of this method is to createProject required cronjobs or modifying the type system (setting e.g some
	 * default values)
	 * 
	 * @param params
	...
	/**
	 * Implement this method to createProject data that is used in your project. This method will be called during the system
	 * initialization.
	 * 
